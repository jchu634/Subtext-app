  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block size-4 rounded-full bg-orange-400 ring-0 shadow-lg transition-transform data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0 dark:bg-black",
        )}
      />
    </SwitchPrimitive.Root>
  );
